...
Revision ID: 0dcb864f20be
Revises: 
Create Date: 2026-01-12 17:02:53.105438
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('GUEST', 'MEMBER', 'ADMIN', name='role'), nullable=False),
